...
class ServiceController extends Controller
{
    ...
    {
        $this->middleware('permission:admin-services-read|admin-services-create|admin-services-write', ['only' => ['index','store']]);
        $this->middleware('permission:admin-services-create', ['only' => ['create','store']]);
        $this->middleware('permission:admin-services-write', ['only' => ['edit','update','destroy']]);
    }
