...
class RoleController extends Controller
{
    ...
    {
         $this->middleware('permission:admin-roles-read|admin-roles-create|admin-roles-write', ['only' => ['index','store']]);
         $this->middleware('permission:admin-roles-create', ['only' => ['create','store']]);
         $this->middleware('permission:admin-roles-write', ['only' => ['edit','update','destroy']]);
    }
    ...
    {
        $roles = Role::where('workshop_id',0)->where('name','!=','workshop')->orderBy('id','DESC')->get();
