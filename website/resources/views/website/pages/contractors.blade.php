...
{{--                                    </div>--}}
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <select class="form-select" name="location_id" aria-label="Default select example">
                                            <option value="">Selection locations</option>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="input-group">
                                            <input type="search" name="search" class="form-control" placeholder="Search A contractor">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-12">
                                <div class="contractor-img">
                                    <img src="{{config('app.url') .'/workshop/Image'.'/'.$contractor['logo']}}" class="img-fluid">
                                </div>
                            </div>
