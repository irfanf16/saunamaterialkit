    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="kt_account_profile_details_form" method="POST" class="form" action="{{route('products.update',$product->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <!--begin::Card body-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="name" class="form-control form-control-lg form-control-solid "
                                       @error('name') style="border-color: red;" @enderror placeholder="Enter Product Name" value="{{$product->name}}"/>
                                @error('name')
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   name="size[]" id="" min="0" value="{{$variants->size}}"
                                                                   placeholder="Enter Name" required>
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                                   class="form-control form-control-lg form-control-solid"
                                                                   name="price[]" id="" min="0"  value="{{$variants->price}}"
                                                                   placeholder="Enter price" required>
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                                   class="form-control form-control-lg form-control-solid"
                                                                   name="unit[]" id="" min="0"  value="{{$variants->unit}}"
                                                                   placeholder="Enter unit" required>
                                                        </td>

                                                        <td>
                                                            <button class="btn-sm form-control form-control-lg form-control-solid   delete-action delete-row-table" data-id="{{$variants->id}}">
    ...
    <script>
        ...
        // `);
            body.append(
                $('<tr/>').append(
                    $('<td/>').append(
                        $('<input>',{type:'text','class':'form-control form-control-lg form-control-solid',name:'size[]',placeholder:'Enter name','required':'required'})
                    ),
                    $('<td/>').append(
                        $('<input>',{type:'text','class':'form-control form-control-lg form-control-solid',name:'price[]',placeholder:'Enter name','required':'required'})
                    ),
                    $('<td/>').append(
                        $('<input>',{type:'text','class':'form-control form-control-lg form-control-solid',name:'unit[]',placeholder:'Enter name','required':'required'})
                    ),
                    $('<td/>').append(
                        $('<button/>',{'class':'btn-sm form-control form-control-lg form-control-solid   delete-action delete-row-table'}).append(
