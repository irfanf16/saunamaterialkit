                ...
                <form id="kt_account_profile_details_form" method="POST" class="form"
                    ...
                    <div class="card-body border-top p-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        <input type="text" name="name"
                                               ...
                                               placeholder="Enter name" @error('name') style="border-color: red;"
                                               @enderror value="{{$workshop->adminUser[0]->name}}"/>
                                        @error('name')
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        <input type="email" disabled name="email"
                                               ...
                                               @error('email') style="border-color: red;"
                                               @enderror placeholder="Enter Email" value="{{$workshop->adminUser[0]->email}}"/>
                                        @error('email')
                                        <div class="alert ">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="workshop_name"
                                       class="form-control form-control-lg form-control-solid"
                                       @error('workshop_name') style="border-color: red;"
                                       @enderror placeholder="Enter Workshop Name" value="{{$workshop->name}}"/>
                                @error('workshop_name')
                                <div class="alert ">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="workshop_address"
                                       class="form-control form-control-lg form-control-solid"
                                       @error('workshop_address') style="border-color: red;"
                                       @enderror placeholder="Workshop Address" value=" {{$workshop->address}}"/>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="password"
                                       class="form-control form-control-lg form-control-solid"
                                       @error('password') style="border-color: red;"
                                       @enderror placeholder="Workshop Password" value="{{old('password')}}"/>
                                @error('password')
                                <div class="alert ">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <select name="locations" aria-label="Select a Locations" data-control="select2"
                                        @error('locations') style="border-color: red;"
                                        @enderror data-placeholder="Select a Location..."
                                        class="form-select form-select-solid form-select-lg fw-semibold">
                                    @foreach($locations as $location)
                                        @foreach($workshop->locations as $lc)
                                            @if($location->id==$lc->id)
                        ...
                        <div class="row mb-6">
                            ...
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                ...
                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                   title="List of services"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <select multiple name="services" aria-label="Select a Services" data-control="select2"
                                        @error('services') style="border-color: red;"
                                        @enderror data-placeholder="Select a Services..."
                                        class="form-select form-select-solid form-select-lg fw-semibold">

                                    @foreach($services as $service)
                                        @foreach($workshop->services as $ser)
