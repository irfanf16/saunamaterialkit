                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="name" class="form-control form-control-lg form-control-solid"
                                       ...
                                       @enderror placeholder="Enter Service Name" value="{{$location->name}}"/>
                                @error('name')
                                                ...
                                                <table id="add_sku"
                                                    ...
                                                    @foreach($location->cities as $city)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn-sm form-control form-control-lg form-control-solid   delete-action delete-row-table">
