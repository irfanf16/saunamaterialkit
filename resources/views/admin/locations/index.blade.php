...
{{--                        </td>--}}
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <a href="javascript:void(0)" class="text-gray-800 text-hover-primary mb-1">{{$location->name}}</a>
                            </div>
                            <!--begin::User details-->
                        </td>
                        <td>{{ \Carbon\Carbon::parse($location->created_at)->isoFormat('MMM Do YYYY')}}</td>
                        <td>
                            @foreach($location->cities as $city)  <span class="span">{{$city->name}} ,</span> @endforeach
                        </td>
                        <!--begin::Joined-->
                        <!--begin::Action=-->
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('locations.edit',$location->id) }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
